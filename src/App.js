  ...
  return (
    <div className="container">
      <div className="smartphone">
        ...
        <div className="absolute bottom-8 inset-x-0 -20">
          <div className="flex justify-between px-10">
            <button className="bg-gray-800 rounded-full p-2 bg-opacity-50">
              <svg
        ...
        <div className="absolute bottom-2 inset-x-0">
          <div className="h-1 mx-auto w-28 bg-white rounded"></div>
        </div>
      </div>
    </div>
  );
